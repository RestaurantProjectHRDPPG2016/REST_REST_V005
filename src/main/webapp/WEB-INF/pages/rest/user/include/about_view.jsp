...
<div class="panel ">
			...
			<div class="panel panel-body">
				...
				<div class="row">
                	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
									<button class="fab" style="margin-top:20px;">
				...
				<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="media">
							  ...
							  <h4 class="media-heading">What programming terms have you coined that have taken off in your own circles (i.e. have heard others repeat it)? 
							  It might be within your own team, workplace or garnered greater popularity on the Internet.</h4>
							  </div>
						</div>
						</div>
						<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="media">
							  ...
							  <div class="media-body thumbnail">
							    <h4 class="media-heading">"The way a team plays as a whole determines its success. You may have the greatest bunch of individual 
							    stars in the world, but if they don't play together, the club won't be worth a dime." </h4>
						...
						<div class="media">
							  ...
							  <div class="media-body thumbnail">
							   <h4 class="media-heading">"It's better to understand either Philosophy or Psychology in the daily life.
							     Neither temper nor selfish will lead us to success. Open-minded, not greedy, not coward and be a rational human.
							     "</h4>
							  </div>
						</div>
						</div>
						...
						<div class="media">
							  ...
							  <div class="media-body thumbnail">
							    <h4 class="media-heading">Everybody always say a popular website or a social enterprise can't run with a developer . 
							    But for me I will show to there people it can and more than they thinking .
